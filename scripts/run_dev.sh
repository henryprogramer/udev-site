...
echo "- Portal gestao: http://localhost:8000/gestao"
echo ""
echo "URL's para ADM's:"
echo "- E-mail autorizado: $MANAGER_EMAIL"
echo "- Solicitar token: http://localhost:8000/gestao/token/"
echo "- Token local (modo arquivo): logs/mail_outbox/"
echo ""
